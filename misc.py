...
def generate_random_transport_problem(
        num_sources,
        num_destinations,
        min_cost,
        max_cost,
    ...
    cost_matrix = np.random.randint(
        min_cost, max_cost + 1, size=(num_sources, num_destinations)
    )
...
def test_time_mem(
    ...
    transportation_matrix, cost = func(data, method)
